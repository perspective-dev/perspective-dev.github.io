...
import { DuckDBHandler } from "https://cdn.jsdelivr.net/npm/@perspective-dev/client@5.2.0/dist/esm/virtual_servers/duckdb.js";
...
async function loadSampleData(db) {
    const response = await fetch(
        "https://cdn.jsdelivr.net/npm/superstore-arrow@3.2.0/superstore.lz4.arrow",
    );
